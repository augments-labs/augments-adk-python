...
2. **No memory-layer leakage.** Never write `.agents/`, `.claude/`,
   `AGENTS.md`, `CLAUDE.md`, a rule basename, or a governance pointer
   ("per the X rule", "see X") into a docstring. If you SEE existing leakage, report it under
