...
Constraints live in `.agents/rules/items.md` and `type-layers.md` (load
...
round-trip, and `ItemHelpers` mapping. Run the `code-hygiene-gate` skill. No `NotImplementedError`.
