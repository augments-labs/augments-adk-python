...
See ``augments.adk.verbose.config`` for the public API. Wire via
...
from augments.adk.verbose.panel_renderer import PanelRenderer, StreamCallType
from augments.adk.verbose.renderer import VerboseRenderer, format_payload
...
__all__ = [
    ...
    "EVENT_HITL_APPROVAL_GRANTED",
    "EVENT_HITL_APPROVAL_REJECTED",
    # Reserved events — Augments ADK enrichment beyond CrewAI
    "EVENT_HITL_APPROVAL_REQUESTED",
    "EVENT_KNOWLEDGE_QUERY",
    "EVENT_KNOWLEDGE_RESULT",
    "EVENT_LLM_END",
