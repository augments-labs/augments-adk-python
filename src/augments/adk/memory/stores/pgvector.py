...
try:
    ...
    raise ImportError("PgVectorStore requires psycopg + pgvector: pip install 'augments-adk[memory-pgvector]'") from exc
...
from augments.adk.memory.vector_store import VectorQueryResult, VectorRecord
