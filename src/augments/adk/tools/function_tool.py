...
from augments.adk.schemas import SchemaEnforcement, enforce_schema
...
from augments.adk.types.tools import ApprovalPolicy
...
class FunctionTool:
    ...
    ``augments.adk.exceptions.ToolDependencyError`` listing every
