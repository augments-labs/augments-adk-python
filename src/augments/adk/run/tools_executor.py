...
from augments.adk.run.cost import apply_result_limits, check_tool_call_limits_before_dispatch, minify_json
from augments.adk.run.governance import emit_audit, emit_guardrail_audit, enforce_tenant_allowlist
...
def maybe_wrap_with_agent_middleware(
    ...
    from augments.adk.tools.tool_middleware import (
...
async def execute_approved_tool(
    ...
    """
    from augments.adk.run.config import get_messages
    from augments.adk.run.llm_calls import resolve_model_name
    from augments.adk.tools.tool_context import ToolContext
    from augments.adk.tools.tool_guardrails import ToolOutputGuardrailData
    ...
    from augments.adk.run.llm_calls import resolve_function_tool
    ...
    if tool.history_aware:
        ...
        from augments.adk.tools.tool_context import HistoryAwareToolContext
...
async def _execute_single_tool_call(
    ...
    from augments.adk.types.tools.tool_output_types import ToolOutputFileContent, ToolOutputImage, ToolOutputText
    ...
    if (
        ...
        from augments.adk.types.input.llm_input_image import LLMInputImage
...
async def execute_tool_calls_streamed(
    ...
    Returns:
        ...
        If deferred_requests is not None, execution was interrupted for approval.
    """
    from augments.adk.run.stream import CancelMode, RunItemStreamEvent, RunItemType
    from augments.adk.tools.deferred_tool import (
        DeferredToolCall,
        DeferredToolRequests,
    )
