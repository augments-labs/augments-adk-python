...
from augments.adk.tasks.task_output import _output_preview
...
class TaskPipeline[TContext]:
    ...
    Example:
        ::
            ...
            from augments.adk import Agent, Task, TaskPipeline, Runner
    ...
    def __post_init__(self) -> None:
        ...
        Raises:
            ...
            TaskPipelineDefinitionError: When the pipeline declares an
                ...
                ``augments.adk.exceptions.exceptions.UserError``.
        """
        if len(self.tasks) == 0:
        ...
        if any(t.depends_on is not None and len(t.depends_on) > 0 for t in self.tasks):
            from augments.adk.tasks.topology import topological_levels
