...
Cross-references:
* ``augments.adk.sandbox.capabilities.memory.MemoryCapability`` — the
  capability surface that wires generation into the agent loop.
"""

from __future__ import annotations

from augments.adk.sandbox.memory.consolidation import run_consolidation
...
from augments.adk.sandbox.memory.manager import SandboxMemoryManager
...
from augments.adk.sandbox.memory.rollout_extraction import run_rollout_extraction
from augments.adk.sandbox.memory.rollouts import (
    build_rollout_payload,
    dump_rollout_json,
    terminal_metadata_for_exception,
    terminal_metadata_for_result,
)
from augments.adk.sandbox.memory.storage import (
