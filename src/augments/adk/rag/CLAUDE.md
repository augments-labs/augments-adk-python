...
| **Provider imports stay lazy** | Third-party imports live inside `load` helpers, tagged `# pyright: ignore[reportMissingImports]` | `import augments.adk.rag` works on a minimal install |
