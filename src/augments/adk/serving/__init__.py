"""HTTP serving layer for the Augments ADK.
...
The Starlette + sse-starlette stack is an optional extra. Install with::
    ...
    pip install 'augments-adk[server]'
...
wiring gracefully. The mechanism mirrors ``augments.adk.a2a``.
"""
