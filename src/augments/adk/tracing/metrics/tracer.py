...
class MetricsTracer:
    ...
    def agent_span(self, data: AgentSpanData) -> Span[AgentSpanData]:
        ...
        Returns:
            A ``MetricSpan`` that records ``augments.agent.turn.duration_ms``
            at finish.
        """
    ...
    def function_span(self, data: FunctionSpanData) -> Span[FunctionSpanData]:
        ...
        Returns:
            A ``MetricSpan`` that increments ``augments.agent.tool.calls``
            at finish.
        """
    ...
    def generation_span(self, data: GenerationSpanData) -> Span[GenerationSpanData]:
        ...
        Returns:
            ...
            ``augments.llm.requests`` counter at finish.
        """
    ...
    def custom_span(self, data: CustomSpanData) -> Span[CustomSpanData]:
        ...
        ``augments.graph.node.duration_ms``; ``"swarm_turn"`` records
        ``augments.swarm.turn.duration_ms``; all other types return a
        no-record span.
