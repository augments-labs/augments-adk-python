...
from augments.adk.tracing.tracer import get_tracer
...
_current_span: ContextVar[Span[Any] | None] = ContextVar("augments_current_span", default=None)
    ...
    *,
    ...
    Args:
        ...
        tenant_id: Opaque tenant identifier, surfaced as the
            ``augments.tenant.id`` span attribute.
...
def graph_span(
    *,
    ...
    apply graph-specific attribute conventions (the ``augments.graph.*``
    namespace).
