"""Framework-level tracing for the Augments Agents ADK.
...
from augments.adk.tracing.logging import log_event
from augments.adk.tracing.multi_tracer import MultiTracer
from augments.adk.tracing.spans import (
    NoOpSpan,
    Span,
    agent_span,
    current_span,
...
from augments.adk.tracing.tracer import Flushable, NoOpTracer, Tracer, flush_traces, get_tracer, set_tracer
...
if TYPE_CHECKING:
    ...
    from augments.adk.tracing.metrics import MetricsTracer, setup_metrics
    from augments.adk.tracing.otel import OTelTracer, setup_otel, setup_otel_from_env
