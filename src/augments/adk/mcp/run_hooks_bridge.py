...
active_run_hooks: ContextVar[RunHooks[Any] | None] = ContextVar("augments_mcp_active_run_hooks", default=None)
"""Active ``RunHooks`` for the calling task. ``None`` outside a run."""

active_run_context: ContextVar[RunContext[Any] | None] = ContextVar("augments_mcp_active_run_context", default=None)
