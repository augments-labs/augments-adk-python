...
``augments.adk.tools.toolsets.mcp_toolset`` because it is a ``Toolset``
...
if TYPE_CHECKING:
    from augments.adk.mcp.auth import HeaderProvider
    from augments.adk.mcp.elicitation import ElicitationHandler
    from augments.adk.mcp.exceptions import (
        MCPConnectionError,
        MCPError,
    ...
    from augments.adk.mcp.filters import ToolFilter, ToolFilterContext
    ...
    from augments.adk.mcp.mcp_server import (
        MCPServer,  # pyright: ignore[reportUnusedImport]
        MCPServerWithClientSession,
    )
    from augments.adk.mcp.sse import MCPServerSse, MCPServerSseParams
    from augments.adk.mcp.stdio import MCPServerStdio, MCPServerStdioParams
else:
    try:
        from augments.adk.mcp.auth import HeaderProvider
        from augments.adk.mcp.elicitation import ElicitationHandler
        ...
        from augments.adk.mcp.http import MCPServerStreamableHttp, MCPServerStreamableHttpParams
        from augments.adk.mcp.manager import MCPServerManager
        from augments.adk.mcp.mcp_server import MCPServer, MCPServerWithClientSession
        from augments.adk.mcp.sse import MCPServerSse, MCPServerSseParams
        from augments.adk.mcp.stdio import MCPServerStdio, MCPServerStdioParams
