...
| **Framework errors propagate** | `AugmentsError` subclasses (budget kill, guardrail reject) bypass routing | These are policy decisions, not candidate failures; escalation would mask them |
