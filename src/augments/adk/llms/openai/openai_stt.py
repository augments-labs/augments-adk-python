...
from augments.adk.voice.audio import DEFAULT_SAMPLE_RATE
from augments.adk.voice.exceptions import STTError, STTWebsocketError
from augments.adk.voice.stt import StreamedTranscriptionSession, STTModel

if TYPE_CHECKING:
    from openai import AsyncOpenAI

    from augments.adk.voice.audio import AudioInput, StreamedAudioInput
    from augments.adk.voice.stt import STTModelSettings
        ...
        if client is None:
            try:
                ...
                raise ImportError(
                    ...
                    "Install it with: pip install 'augments-adk[voice]'"
                ) from exc
    ...
    async def _connect(self) -> Any:
        ...
        try:
            ...
            raise STTWebsocketError(
                "Realtime speech-to-text requires 'websockets'. Install it with: pip install 'augments-adk[voice]'"
            ) from exc
