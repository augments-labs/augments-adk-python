...
composed inside ``call_llm_streamed`` in ``augments.adk.run.llm_calls``.
...
if TYPE_CHECKING:
    ...
    from augments.adk.llms.llm_middleware import LLMMiddleware, LLMMiddlewareNext
...
class LLMStreamMiddlewareTermination(AugmentsError):
    ...
    *,
    ...
    Returns:
        ...
        Register each in its respective slot::
            ...
            from augments.adk.llms.llm_stream_middleware import make_logging_middlewares
