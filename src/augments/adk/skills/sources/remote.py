...
from augments.adk.skills.sources.base import SkillSource
...
class RemoteSkillSource(SkillSource):
    ...
    async def load(self) -> Skill:
        ...
        from augments.adk.skills.skill import Skill, SkillMetadata
        from augments.adk.skills.sources.directory import parse_skill_md
