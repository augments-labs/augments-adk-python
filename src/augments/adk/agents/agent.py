...
from augments.adk.handoffs import Handoff, HandoffRoute
from augments.adk.llms import LLM, LLMConfig
from augments.adk.prompts import DynamicSystemPrompt, SystemPrompt
from augments.adk.schemas import AgentOutputSchemaBase
from augments.adk.skills.activation import SkillActivation
from augments.adk.tools import FunctionTool, FunctionToolset, Tool, Toolset
from augments.adk.types.tools import ToolUseBehavior
from augments.adk.utils import MaybeAwaitable, to_snake_case

logger = logging.getLogger(__name__)

if TYPE_CHECKING:
    from augments.adk.hooks import AgentHooks, RunHooks
    from augments.adk.llms.llm_usage import LLMUsageLimits
    from augments.adk.run import RunConfig
    from augments.adk.run.stream import StreamEvent
    ...
    from augments.adk.types.agents.agent_as_tool_types import (
...
class BaseAgent(Generic[TContext]):
    ...
    Toolset example::
        ...
        from augments.adk.tools import FunctionToolset
...
class Agent(BaseAgent, Generic[TContext]):
    ...
    Agents are the core building blocks of the Augments framework. They combine:
    ...
    **LLM-orchestrated** (list): Agents exposed as transfer_to_<name> tools.
    ...
    Example::
        ...
        from augments.adk.agents import Middleware
    ...
    def as_tool(
        ...
        *,
        ...
        from augments.adk.schemas import SchemaEnforcement
        from augments.adk.types.agents.agent_as_tool_types import AgentToolInput
        ...
        async def _on_invoke_tool(ctx: ToolContext, raw_input: str) -> str:
            ...
            try:
                ...
                from augments.adk.exceptions import AgentToolDeferral, UserError
...
def _merge_budget(
    ...
    """
    from augments.adk.run import RunConfig as _RunConfig
