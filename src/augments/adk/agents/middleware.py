...
Protocol docstrings under ``augments.adk.tools.tool_middleware``,
``augments.adk.run.agent_middleware``,
``augments.adk.llms.llm_middleware``, and
``augments.adk.llms.llm_stream_middleware`` for the
...
if TYPE_CHECKING:
    ...
    from augments.adk.llms.llm_stream_middleware import LLMStreamMiddleware
    from augments.adk.run.agent_middleware import AgentMiddleware
    from augments.adk.tools.tool_middleware import ToolMiddleware
