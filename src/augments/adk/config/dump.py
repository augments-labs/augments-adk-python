...
_PROVIDER_CLASSES: tuple[tuple[str, str], ...] = (
    ("anthropic", "augments.adk.llms.anthropic.anthropic_model:AnthropicLLM"),
    ("openai-responses", "augments.adk.llms.openai.openai_responses_model:OpenAIResponsesLLM"),
    ("openai-chat", "augments.adk.llms.openai.openai_chatcompletions_model:OpenAIChatCompletionsLLM"),
    ("gemini", "augments.adk.llms.gemini.gemini_model:GeminiLLM"),
    ("litellm", "augments.adk.llms.litellm.litellm_model:LiteLLM"),
)
