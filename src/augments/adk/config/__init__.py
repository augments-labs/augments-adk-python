"""Declarative agent configuration for the Augments ADK.
...
from augments.adk.config.hosted_tools import register_hosted_tool
from augments.adk.config.loader import load_agent
from augments.adk.config.providers import register_llm_provider
from augments.adk.config.resolver import resolve_dotted_spec
from augments.adk.config.topology import AgentTopology, build_topology, load_topology
