...
The reserved types in `src/augments/adk/types/permissions/` model Anthropic's
...
See `src/augments/adk/types/permissions/CLAUDE.md` for the reserved type catalog
