...
> (see `src/augments/adk/run/config.py`).
>
...
Until that ships, `src/augments/adk/permissions/__init__.py` only re-exports these
...
CLAUDE.md under `src/augments/adk/permissions/` for runner integration status.
