...
class MessageOutputItem(RunItemBase["list[LLMResponseText | LLMResponseRefusal]"]):
    ...
    def to_param(self) -> LLMInputContentItem:
        ...
        from augments.adk.types.output import LLMResponseMessageParam
...
class ToolCallOutputItem(RunItemBase["FunctionToolCallResult"]):
    ...
    def to_param(self) -> LLMInputContentItem:
        ...
        from augments.adk.types.output import FunctionToolCallResultParam
...
class MCPListToolsItem(RunItemBase["MCPListTools"]):
    ...
    def to_param(self) -> LLMInputContentItem:
        ...
        from augments.adk.types.tools.builtin_tool_types import MCPListToolsTool as _MCPListToolsTool
...
class ToolApprovalItem(RunItemBase["DeferredToolCall"]):
    ...
    @override
    def to_param(self) -> LLMInputContentItem:
        from augments.adk.types.output import FunctionToolCallResultParam as _Param
...
class ItemHelpers:
    ...
    def refusal_message_output(item: MessageOutputItem) -> str | None:
        ...
        """
        from augments.adk.types.responses.llm_response import LLMResponseRefusal as _Refusal
    ...
    def message_to_run_items(
        ...
        if role in ("system", "developer"):
            from augments.adk.types.input import LLMInputEasyMessage as _EasyMsg
