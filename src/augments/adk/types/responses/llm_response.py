...
if TYPE_CHECKING:
    from augments.adk.types.output.llm_response_function_tool_call_param import (
        LLMResponseFunctionToolCallParam,
    )
    from augments.adk.types.output.llm_response_provider_item_param import (
        LLMResponseProviderItemParam,
    )
    from augments.adk.types.output.llm_response_reasoning_param import (
