...
Requires ``boto3>=1.34.0``: ``pip install 'augments-adk[checkpointer-s3]'``.
"""
...
try:
    ...
    raise ImportError("S3Checkpointer requires boto3>=1.34.0: pip install 'augments-adk[checkpointer-s3]'") from exc
