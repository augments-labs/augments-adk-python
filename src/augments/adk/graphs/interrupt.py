...
class InterruptException(AugmentsError):
...
class NestedAgentResumeError(AugmentsError):
...
class GraphResumeError(AugmentsError):
...
class NestedAgentSerializationError(AugmentsError):
