...
class Graph[TContext](Executable[TContext]):
    ...
    def to_mermaid(self, *, direction: MermaidDirection = "LR") -> str:
        ...
        ``augments.adk.visualization.graph_to_mermaid``. Pure
        ...
        """
        from augments.adk.visualization.mermaid import graph_to_mermaid
    ...
    def to_dot(self, *, rankdir: DotRankdir = "LR") -> str:
        ...
        Thin ergonomic wrapper around
        ``augments.adk.visualization.graph_to_dot``. Pure function:
        ...
        """
        from augments.adk.visualization.dot import graph_to_dot
