...
from augments.adk.a2a.a2a_continuation_token import A2AContinuationToken, A2ATaskStatus
from augments.adk.a2a.converters import stream_response_to_event
from augments.adk.a2a.exceptions import (
    A2AProtocolError,
...
if TYPE_CHECKING:
    ...
    from augments.adk.a2a.a2a_agent import A2ARunResult, A2AStreamEvent
        ...
        *,
        ...
        Raises:
            ...
            A2AProtocolError: Protocol-level failure from the remote
                endpoint.
        """
        from augments.adk.a2a.a2a_agent import A2ARunResult  # avoid cycle
