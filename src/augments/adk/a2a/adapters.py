...
``augments.adk.graphs.graph.Graph`` alongside local ``Agent``,
...
Usage::
    ...
    from augments.adk.a2a.adapters import A2AExecutableAdapter
...
from augments.adk.a2a.a2a_agent import A2AAgent
