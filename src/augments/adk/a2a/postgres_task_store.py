...
(psycopg). Install with ``pip install 'augments-adk[a2a,a2a-postgres]'``.
"""
...
try:
    ...
    raise ImportError(
        "PostgresTaskStore requires psycopg[binary,pool]>=3.2: pip install 'augments-adk[a2a-postgres]'"
    ) from exc
