...
from augments.adk.flows.registry import build_transition_table
from augments.adk.flows.result import FlowRunResult, FlowRunStatus
from augments.adk.flows.step_context import FlowStepContext
...
if TYPE_CHECKING:
    ...
    from augments.adk.flows.registry import FlowTransitionTable
...
class FlowExecutor[StateT]:
    ...
    def __init__(
        ...
        *,
        ...
        from augments.adk.flows.flow import collect_step_descriptions
    ...
    async def _gate_step(self, name: str, step: FlowStep, ctx: FlowStepContext[StateT]) -> None:
        ...
        ``augments.adk.run.tools_executor``: enablement and approval
