...
try:
    ...
    raise ImportError(
        "S3SwarmCheckpointer requires boto3>=1.34.0: pip install 'augments-adk[checkpointer-s3]'"
    ) from exc

from augments.adk.swarms.checkpointer import SwarmCheckpoint, SwarmHookRegistry
