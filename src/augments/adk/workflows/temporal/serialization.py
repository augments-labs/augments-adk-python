"""Temporal DataConverter factory for Augments ADK.
...
from augments.adk.schemas.agent_output_schema import AgentOutputSchemaBase

if TYPE_CHECKING:
    from temporalio.converter import DataConverter

    from augments.adk.llms.llm_config import LLMConfig
    from augments.adk.tools import FunctionTool, Tool
...
def build_augments_data_converter() -> DataConverter:
    """Return a Temporal ``DataConverter`` for Augments workflows.
...
def tool_to_json_dict(tool: Tool) -> dict[str, Any] | None:
    ...
    """
    from augments.adk.schemas.utils import SchemaEnforcement, normalize_schema
