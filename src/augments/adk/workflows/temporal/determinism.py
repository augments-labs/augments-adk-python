"""Temporal sandbox passthrough configuration for Augments ADK.
...
Augments workflows and provides a factory that produces a configured
...
def build_sandbox_restrictions(
    ...
    *,
    ...
    """Return a ``SandboxRestrictions`` for Augments workflows.
