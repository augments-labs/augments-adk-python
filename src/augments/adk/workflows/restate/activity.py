...
async def invoke_model_handler(
    ...
    if tools_json:
        from augments.adk.workflows.temporal.serialization import tool_from_json_dict
    ...
    if output_schema_json:
        from augments.adk.workflows.temporal.serialization import output_schema_from_json_dict
